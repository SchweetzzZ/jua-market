                    ...
                    <div className="flex flex-col">
                        <div className="mb-8">
                            ...
                            <p className="text-lg text-slate-600 leading-relaxed bg-white p-8 rounded-3xl border border-slate-100 shadow-sm mb-8">
                                {servico.description || "Este profissional ainda não disponibilizou uma descrição completa do serviço."}
                            </p>
                        </div>
                        ...
                        {user && (
                            <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm mb-8">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div>
                                        <p className="text-xs text-slate-400 font-bold uppercase tracking-widest mb-1">Profissional Verificado</p>
