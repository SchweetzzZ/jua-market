                            ...
                            <div className="relative group/seller">
                                ...
                                <div className="relative bg-white rounded-[2rem] p-8 ring-1 ring-slate-200 shadow-xl shadow-slate-200/50">
                                    ...
                                    <a
                                        ...
                                        className="flex items-center justify-center gap-3 w-full bg-green-600 text-white font-bold px-8 py-5 rounded-[1.25rem] hover:bg-green-700 transition-all shadow-xl shadow-slate-200 active:scale-[0.98] group/btn"
                                    >
