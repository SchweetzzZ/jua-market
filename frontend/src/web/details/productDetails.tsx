                    ...
                    <div className="lg:col-span-6 flex flex-col pt-4">
                        <div className="mb-10">
                            <header className="mb-10">
                                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 border border-indigo-100 mb-6">
                                    ...
                                    <span className="text-[10px] font-black uppercase tracking-[0.1em] text-indigo-700">Venda Local em Juazeiro</span>
                                </div>
                                ...
                                <div className="flex flex-col sm:flex-row gap-8 items-start sm:items-center">
                                    <div className="flex flex-col">
                                        <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Preço de Venda</span>
                        ...
                        {user && (
                            <div className="relative group/seller">
                                ...
                                <div className="relative bg-white rounded-[2rem] p-8 ring-1 ring-slate-200 shadow-xl shadow-slate-200/50">
                                    <div className="flex items-center gap-6 mb-8 pb-8 border-b border-slate-100">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Anunciando no Marketplace</p>
                                        </div>
                                    </div>
                                    ...
                                    <a
                                        ...
                                        className="flex items-center justify-center gap-3 w-full bg-slate-950 text-white font-bold px-8 py-5 rounded-[1.25rem] hover:bg-indigo-700 transition-all shadow-xl shadow-slate-200 active:scale-[0.98] group/btn"
                                    >
